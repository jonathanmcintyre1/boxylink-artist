...
<div class="page-header">
   <h4 class="page-title">Edit vCard</h4>
   ...
   <div class="col-md-12">
      <div class="card">
         <div class="card-header">
            <div class="card-title d-inline-block">Edit vCard</div>
                      ...
                      <div class="row">
                           <div class="col-lg-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" name="vcard_name" value="{{$vcard->vcard_name}}" placeholder="Enter vcard name">
                     ...
                     <div class="row">
                        <div class="col-lg-6">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="name" value="{{$vcard->name}}" placeholder="Enter name">
                        ...
                        <div class="col-lg-6">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="occupation" value="{{$vcard->occupation}}" placeholder="Enter occupation">
                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-12">
                           <div class="form-group">
                              ...
                              <textarea name="introduction" id="introduction" class="form-control" rows="4" placeholder="Enter Introduction">{{$vcard->introduction}}</textarea>
                           </div>
                        </div>
                     </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                   <label for="">Label</label>
                                    <input name="labels[]" class="form-control" v-model="information.label" type="text" >
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                   <label for="">Value</label>
                                    <input name="values[]" class="form-control" v-model="information.value" type="text" >
               ...
               addIcpEvent() {
                ...
                addInformation() {
                   ...
                   let uniqid = this.uniqid();
                    this.infromations.push({uniqid: uniqid, icon: 'fas fa-heart', color: '000000', label: '', value: ''});
