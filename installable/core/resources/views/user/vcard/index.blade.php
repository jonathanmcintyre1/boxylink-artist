                                    ...
                                    <table class="table table-striped mt-3" id="basic-datatables">
                                        ...
                                        @foreach ($vcards as $key => $vcard)
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{asset('assets/front/img/user/vcard-templates/' . $vcard->template . '.jpg')}}" alt="" width="65">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <a class="btn btn-secondary btn-sm" href="{{route('user.vcard.edit', $vcard->id)}}">
