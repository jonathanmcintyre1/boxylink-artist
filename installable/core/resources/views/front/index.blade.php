                ...
                <div id="monthly" class="tab-pane active">
                    <div class="row no-gutters ">
                        @foreach($packages as $package)
                            @php
                                $allFeatures = ['Custom Domain', 'Subdomain', 'QR Builder', 'vCard', 'Online CV & Export', 'Follow/Unfollow', 'Blog', 'Portfolio', 'Skill', 'Achievements', 'Service', 'Experience', 'Testimonial'];
